...
for i = 1:length(ALL_Data)
    ...
    reference=192;
    FFT_result_0=[FFT_result_0(1:reference-1,:);FFT_result_0(reference-1,:);FFT_result_0(reference+1:end,:)];
...
%     FFT_result_0=FFT_result_0-repmat(mean(FFT_result_0,1),size(FFT_result_0,1),1);
    ...
    Hz_int=[60,62,180,182,300,320];
    FFT_result_0=[FFT_result_0(:,1:Hz_int(1)),FFT_result_0(:,Hz_int(1)),FFT_result_0(:,Hz_int(2):Hz_int(3)),FFT_result_0(:,Hz_int(3))...
        ,FFT_result_0(:,Hz_int(4):Hz_int(5)),FFT_result_0(:,Hz_int(5)),FFT_result_0(:,Hz_int(6):end)];
    ...
    %Delete Interference Electrode(you will find it after you check the LFP average image)
    FFT_result_1=[FFT_result_1(1:reference-1,:);FFT_result_1(reference-1,:);FFT_result_1(reference+1:end,:)];
    
%     FFT_result_1=FFT_result_1-repmat(mean(FFT_result_1,1),size(FFT_result_1,1),1);
    FFT_result_1=[FFT_result_1(:,1:Hz_int(1)),FFT_result_1(:,Hz_int(1)),FFT_result_1(:,Hz_int(2):Hz_int(3)),FFT_result_(1:Hz_int(3))...
        ,FFT_result_1(:,Hz_int(4):Hz_int(5)),FFT_result_1(:,Hz_int(5)),FFT_result_1(:,Hz_int(6):end)];
    ...
    PSD_result_0=[PSD_result_0(1:reference-1,:);PSD_result_0(reference-1,:);PSD_result_0(reference+1:end,:)];
%     PSD_result_0=PSD_result_0-repmat(mean(PSD_result_0,1),size(PSD_result_0,1),1);
    PSD_result_0=[PSD_result_0(:,1:Hz_int(1)-1),PSD_result_0(:,Hz_int(1)-1),PSD_result_0(:,Hz_int(1)-1),PSD_result_0(:,Hz_int(2)+1),PSD_result_0(:,Hz_int(2)+1:end)];
    ...
    PSD_result_1=[PSD_result_1(1:reference-1,:);PSD_result_1(reference-1,:);PSD_result_1(reference+1:end,:)];
%     PSD_result_1=PSD_result_1-repmat(mean(PSD_result_1,1),size(PSD_result_1,1),1);
    PSD_result_1=[PSD_result_1(:,1:Hz_int(1)-1),PSD_result_1(:,Hz_int(1)-1),PSD_result_1(:,Hz_int(1)-1),PSD_result_1(:,Hz_int(2)+1),PSD_result_1(:,Hz_int(2)+1:end)];
