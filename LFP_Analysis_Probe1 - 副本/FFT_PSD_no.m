...
for i = 1:length(ALL_Data)
    ...
    FFT_LFP_0 = Resps(:,:,con_index_0);% contrast=0 LFP data
    FFT_LFP_1 = Resps(:,:,con_index_1);% contrast=1 LFP data
...
%     FFT_LFP_1=FFT_LFP_1_Pre-repmat(FFT_Pretimes_1,1,size(FFT_LFP_1_Pre,2),1);
    ...
    FFT_result_0=FFT_result_0-repmat(mean(FFT_result_0,2),1,size(FFT_result_0,2));
    ...
    FFT_result_1=FFT_result_1-repmat(mean(FFT_result_1,2),1,size(FFT_result_1,2));
    ...
    PSD_result_0=PSD_result_0-repmat(mean(PSD_result_0,2),1,size(PSD_result_0,2));
    ...
    PSD_result_1=PSD_result_1-repmat(mean(PSD_result_1,2),1,size(PSD_result_1,2));
