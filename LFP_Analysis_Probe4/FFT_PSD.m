...
%     PSD_result_1=PSD_result_1-repmat(mean(PSD_result_1,1),size(PSD_result_1,1),1);
    ...
    for j = 1:size(Visual_Cortex_Position,2)
        FFT_Data_0{i,j}=FFT_result_0(Visual_Cortex_Position{j},:);
        FFT_Data_1{i,j}=FFT_result_1(Visual_Cortex_Position{j},:);
        PSD_Data_0{i,j}=PSD_result_0(Visual_Cortex_Position{j},:);
        PSD_Data_1{i,j}=PSD_result_1(Visual_Cortex_Position{j},:);
    end
end
save FFT_PSD.mat
